...
T20Conditions.abalado = {
	...
	flags: {t20:{condition:true,durationScene:true,stack:"apavorado"}},
...
T20Conditions.agarrado = {
	...
	flags: {t20:{condition:true,childEffect:["desprevenido","imovel"]}},
...
T20Conditions.alquebrado = {
	...
	flags: {t20:{condition:true,durationScene:true}},
...
T20Conditions.atordoado = {
	...
	flags: {t20:{condition:true,durationScene:true,childEffect:["desprevenido"]}}
}
...
T20Conditions.cego = {
	...
	flags: {t20:{condition:true,durationScene:true,childEffect:["desprevenido","lento"]}},
	changes: [{key: "data.pericias.acr.condi", mode:3, value:-2},
		{key: "data.pericias.atl.condi", mode:3, value:-2},
		{key: "data.pericias.cav.condi", mode:3, value:-2},
		{key: "data.pericias.fur.condi", mode:3, value:-2},
...
T20Conditions.debilitado = {
	...
	flags: {t20:{condition:true,durationScene:true,stack:"inconciente"}},
...
T20Conditions.enredado = {
	...
	flags: {t20:{condition:true,durationScene:true,childEffect:["lento","vulneravel"]}},
	changes: [{key: "data.pericias.lut.condi", mode:3, value:-2},
		{key: "data.pericias.pon.condi", mode:3, value:-2}]
}
...
T20Conditions.exausto = {
	...
	flags: {t20:{condition:true,durationScene:true,stack:"inconsciente",childEffect:["debilitado","lento","vulneravel"]}}
}
...
T20Conditions.fatigado = {
	...
	flags: {t20:{condition:true,durationScene:true,stack:"exausto",childEffect:["fraco","vulneravel"]}}
}
...
T20Conditions.fraco = {
	...
	flags: {t20:{condition:true,durationScene:true,stack:"debilitado"}},
...
T20Conditions.frustrado = {
	...
	flags: {t20:{condition:true,durationScene:true,stack:"esmorecido"}},
...
T20Conditions.inconsciente = {
	...
	flags: {t20:{condition:true,durationScene:true,childEffect:["indefeso"]}}
}
...
T20Conditions.paralisado = {
	...
	flags: {t20:{condition:true,durationScene:true,childEffect:["imovel","indefeso"]}}
}
...
T20Conditions.petrificado = {
	...
	flags: {t20:{condition:true,durationScene:true,childEffect:["inconsciente"]}},
