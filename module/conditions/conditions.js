...
T20Conditions.abalado = {
	...
	flags: {core:{statusId:"abalado"},t20:{condition:true,durationScene:true,stack:"apavorado"}},
...
T20Conditions.agarrado = {
	...
	flags: {core:{statusId:"agarrado"},t20:{condition:true,childEffect:["desprevenido","imovel"]}},
...
T20Conditions.alquebrado = {
	...
	flags: {core:{statusId:"alquebrado"},t20:{condition:true,durationScene:true}},
...
T20Conditions.apavorado = {
	...
	flags: {core:{statusId:"apavorado"},t20:{condition:true,durationScene:true,stack:"apavorado"}},
...
T20Conditions.atordoado = {
	...
	flags: {core:{statusId:"atordoado"},t20:{condition:true,durationScene:true,childEffect:["desprevenido"]}}
}
...
T20Conditions.caido = {
	...
	flags: {core:{statusId:"caido"},t20:{condition:true}},
...
T20Conditions.cego = {
	...
	flags: {core:{statusId:"cego"},t20:{condition:true,durationScene:true,childEffect:["desprevenido","lento"]}},
	changes: [{key: "data.pericias.acr.condi", mode:3, value:-2},
		{key: "data.pericias.atl.condi", mode:3, value:-2},
		{key: "data.pericias.cav.condi", mode:3, value:-2},
		{key: "data.pericias.fur.condi", mode:3, value:-2},
...
T20Conditions.confuso = {
	...
	flags: {core:{statusId:"confuso"},t20:{condition:true,durationScene:true}}
}
...
T20Conditions.debilitado = {
	...
	flags: {core:{statusId:"debilitado"},t20:{condition:true,durationScene:true,stack:"inconciente"}},
...
T20Conditions.desprevenido = {
	...
	flags: {core:{statusId:"desprevenido"},t20:{condition:true,durationScene:true}},
...
T20Conditions.doente = {
	...
	flags: {core:{statusId:"doente"},t20:{condition:true,durationScene:true}}
}
...
T20Conditions.enjoado = {
	...
	flags: {core:{statusId:"enjoado"},t20:{condition:true,durationScene:true}}
}
...
T20Conditions.enredado = {
	...
	flags: {core:{statusId:"enredado"},t20:{condition:true,durationScene:true,childEffect:["lento","vulneravel"]}},
	changes: [{key: "data.pericias.lut.condi", mode:3, value:-2},
		{key: "data.pericias.pon.condi", mode:3, value:-2}]
}
...
T20Conditions.envenenado = {
	...
	flags: {core:{statusId:"envenenado"},t20:{condition:true,durationScene:true}}
}
...
T20Conditions.esmorecido = {
	...
	flags: {core:{statusId:"esmorecido"},t20:{condition:true,durationScene:true}},
...
T20Conditions.exausto = {
	...
	flags: {core:{statusId:"exausto"},t20:{condition:true,durationScene:true,stack:"inconsciente",childEffect:["debilitado","lento","vulneravel"]}}
}
...
T20Conditions.fascinado = {
	...
	flags: {core:{statusId:"fascinado"},t20:{condition:true,durationScene:true}},
...
T20Conditions.fatigado = {
	...
	flags: {core:{statusId:"fatigado"},t20:{condition:true,durationScene:true,stack:"exausto",childEffect:["fraco","vulneravel"]}}
}
...
T20Conditions.fraco = {
	...
	flags: {core:{statusId:"fraco"},t20:{condition:true,durationScene:true,stack:"debilitado"}},
...
T20Conditions.frustrado = {
	...
	flags: {core:{statusId:"frustrado"},t20:{condition:true,durationScene:true,stack:"esmorecido"}},
...
T20Conditions.imovel = {
	...
	flags: {core:{statusId:"imovel"},t20:{condition:true,durationScene:true}},
...
T20Conditions.inconsciente = {
	...
	flags: {core:{statusId:"inconsciente"},t20:{condition:true,durationScene:true,childEffect:["indefeso"]}}
}
...
T20Conditions.indefeso = {
	...
	flags: {core:{statusId:"indefeso"},t20:{condition:true,durationScene:true,childEffect:["desprevenido"]}},
...
T20Conditions.lento = {
	...
	flags: {core:{statusId:"lento"},t20:{condition:true,durationScene:true}},
...
T20Conditions.morto = {
	...
	flags: {core:{statusId:"morto"},t20:{condition:true}}
}
...
T20Conditions.ofuscado = {
	...
	flags: {core:{statusId:"ofuscado"},t20:{condition:true,durationScene:true}},
...
T20Conditions.paralisado = {
	...
	flags: {core:{statusId:"paralisado"},t20:{condition:true,durationScene:true,childEffect:["imovel","indefeso"]}}
}
...
T20Conditions.pasmo = {
	...
	flags: {core:{statusId:"pasmo"},t20:{condition:true,durationScene:true}}
}
...
T20Conditions.petrificado = {
	...
	flags: {core:{statusId:"petrificado"},t20:{condition:true,durationScene:true,childEffect:["inconsciente"]}},
...
T20Conditions.sangrando = {
	...
	flags: {core:{statusId:"sangrando"},t20:{condition:true,durationScene:true}}
}
...
T20Conditions.surdo = {
	...
	flags: {core:{statusId:"surdo"},t20:{condition:true,durationScene:true}},
...
T20Conditions.surpreendido = {
	...
	flags: {core:{statusId:"surpreendido"},t20:{condition:true,durationScene:true,childEffect:["desprevenido"]}}
}
